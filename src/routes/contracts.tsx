...
export const Route = createFileRoute("/contracts")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Histórico de contratos gerados, com download e exclusão." },
    ],
  }),
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Histórico dos contratos criados nesta sessão.
        </p>
      </header>
            ...
            >
              <div className="min-w-0 flex-1 space-y-2">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500">
                  ...
                  <span>{c.replacements.length} substituições</span>
                </div>
              </div>
              <div className="flex flex-shrink-0 gap-2">
                <Button
                  ...
                  onClick={() =>
                    downloadDocx(
                      c.outputFileBase64,
                      `${c.templateName.replace(/\s+/g, "_")}_${c.tenantName.replace(/\s+/g, "_")}.docx`,
                    )
                  }
                >
